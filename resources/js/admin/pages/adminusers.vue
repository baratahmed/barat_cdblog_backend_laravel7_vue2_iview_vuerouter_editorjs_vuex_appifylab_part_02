       ...
       <div class="content">
			<div class="container-fluid">
				...
				<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
					<p class="_title0">All Users <Button @click="addModal=true"><Icon type="md-add" /> Add admin</Button></p>
					...
					<div class="_overflow _table_div">
						<table class="_table">
							...
							<tr v-for="(user, i) in users" :key="i" v-if="users.length">
								...
								<td class="text-danger" v-if="(user.role_id == 1)">Admin</td>
								<td class="text-primary" v-else-if="(user.role_id == 2)">Editor</td>
								<td class="text-warning" v-else-if="(user.role_id == 3)">Moderator</td>
								<td class="text-success" v-else>User</td>
