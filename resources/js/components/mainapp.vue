    ...
    <div>
      ...
      <div class="_1side_menu" >
        <div class="_1side_menu_logo">
          <h3 style="text-align:center;">BitRain BLOG</h3>
          ...
          <div class="_1side_menu_list">
            <ul class="_1side_menu_list_ul">
              <li v-for="(menuItem, i) in permission" :key="i" v-if="permission.length && menuItem.read">
                <router-link :to="'/'+menuItem.name" v-if="menuItem.name!='/'"><Icon type="ios-speedometer" /> {{menuItem.resourceName}}</router-link>
                <router-link :to="'/'" v-else><Icon type="ios-speedometer" /> {{menuItem.resourceName}}</router-link>
              </li>
